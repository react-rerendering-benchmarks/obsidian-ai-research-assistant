...
const IconButton = memo(({
  ...
  return <button className={`ai-research-assistant__icon-button ai-research-assistant__icon-button--${buttonStyle} ai-research-assistant__icon-button--${buttonVariant} clickable-icon ${typeof className !== 'undefined' ? ` ${className}` : ''}`} title={a11yText} {...props}>
      {/* @ts-expect-error */}
